...
@Entity
@Table(name="IB_FINBIT_RES_MIN_BAL")
@JsonIgnoreProperties(ignoreUnknown = true)
public class MinimumBalance 
{
	@Id
	@GeneratedValue(generator = "IB_FINBIT_RES_MIN_BAL_SQC")
	@SequenceGenerator(name = "IB_FINBIT_RES_MIN_BAL_SQC", sequenceName = "IB_FINBIT_RES_MIN_BAL_SQC")
	private int seqId;
