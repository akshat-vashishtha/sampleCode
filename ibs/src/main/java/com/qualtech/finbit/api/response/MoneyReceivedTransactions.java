...
@Entity
@Table(name="IB_FINBIT_RES_REC_TRANS")
@JsonIgnoreProperties(ignoreUnknown = true)
public class MoneyReceivedTransactions 
{
	@Id
	@GeneratedValue(generator = "IB_FINBIT_RES_REC_TRANS_SQC")
	@SequenceGenerator(name = "IB_FINBIT_RES_REC_TRANS_SQC", sequenceName = "IB_FINBIT_RES_REC_TRANS_SQC")
	private int seqId;
