...
@Entity
@Table(name="IB_EX2_REQ_RES")
public class ExperianKickoffReqRes implements Serializable{
	/**
	 * 
	 */
	...
	@JsonIgnore
	@Id
	@GeneratedValue(generator = "EX2_MAIN_SQC")
	@SequenceGenerator(name = "EX2_MAIN_SQC", sequenceName = "IB_EX2_MAIN_SQC")
	private long eid;
