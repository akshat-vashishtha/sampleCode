...
//    @JsonIgnore
    ...
    private final static long serialVersionUID = -788316556490621123L;
    ...
    public Summary_ withTotalresponses(Integer totalresponses) {
        this.totalresponses = totalresponses;
        return this;
    }
    ...
    public Summary_ withNoofothermfis(Integer noofothermfis) {
        this.noofothermfis = noofothermfis;
        return this;
    }
    ...
    public Summary_ withNoofdefaultaccounts(Integer noofdefaultaccounts) {
        this.noofdefaultaccounts = noofdefaultaccounts;
        return this;
    }
    ...
    public Summary_ withNoofownmfis(Integer noofownmfis) {
        this.noofownmfis = noofownmfis;
        return this;
    }
    ...
    public Summary_ withNoofclosedaccounts(Integer noofclosedaccounts) {
        this.noofclosedaccounts = noofclosedaccounts;
        return this;
    }
    ...
    public Summary_ withNoofactiveaccounts(Integer noofactiveaccounts) {
        this.noofactiveaccounts = noofactiveaccounts;
        return this;
    }
    ...
    public Summary_ withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public Summary_ withOwnmfiindecator(Boolean ownmfiindecator) {
        this.ownmfiindecator = ownmfiindecator;
        return this;
    }
...
//    @JsonAnySetter
    ...
    public Summary_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
