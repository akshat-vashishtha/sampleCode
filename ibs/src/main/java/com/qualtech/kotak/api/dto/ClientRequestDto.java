...
public class ClientRequestDto implements Serializable{
	...
	public String toString() {
		return "ClientRequestDto [clientName=" + clientName + ", allowInput=" + allowInput + ", allowEdit=" + allowEdit
				+ ", allowCaptcha=" + allowCaptcha + ", allowConsent=" + allowConsent + ", allowConsent_additional="
				+ allowConsent_additional + ", allowEmailVerify=" + allowEmailVerify + ", allowVoucher=" + allowVoucher
				+ ", voucherCode=" + voucherCode + ", noValidationByPass=" + noValidationByPass
				+ ", emailConditionalByPass=" + emailConditionalByPass + ", firstName=" + firstName + ", middleName="
				+ middleName + ", surName=" + surName + ", dateOfBirth=" + dateOfBirth + ", gender=" + gender
				+ ", mobileNo=" + mobileNo + ", telephoneNo=" + telephoneNo + ", telephoneType=" + telephoneType
				+ ", email=" + email + ", flatno=" + flatno + ", buildingName=" + buildingName + ", roadName="
				+ roadName + ", city=" + city + ", state=" + state + ", pincode=" + pincode + ", pan=" + pan
				+ ", passport=" + passport + ", aadhaar=" + aadhaar + ", voterid=" + voterid + ", driverlicense="
				+ driverlicense + ", rationcard=" + rationcard + ", reason=" + reason + "]";
	}
