...
public class HealthDetails implements Serializable
{
	...
	@SequenceGenerator(name = "REQ_SEQ", sequenceName = "IB_ICICI_CST_HD_SEQ")
	...
	//set String values to "" for null handlation third party API calling
	private String code="";
	...
	public String toString() {
		return "HealthDetails [code=" + code + ", answer1=" + answer1 + ", answer2=" + answer2 + ", answer3=" + answer3
				+ ", answer4=" + answer4 + ", answer5=" + answer5 + ", answer6=" + answer6 + ", answer7=" + answer7
				+ ", answer8=" + answer8 + ", answer9=" + answer9 + ", answer10=" + answer10 + ", answer11=" + answer11
				+ ", answer12=" + answer12 + ", answer13=" + answer13 + ", answer14=" + answer14 + ", answer15="
				+ answer15 + "]";
	}
