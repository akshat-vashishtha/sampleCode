...
/*@Entity
@Table(name="IB_ICICI_CST_PADD")*/
public class PrmntAddress implements Serializable
{
	...
	@SequenceGenerator(name = "REQ_SEQ", sequenceName = "IB_ICICI_CST_PADD_SEQ")
   ...
   /* @OneToOne
	...
	public String toString() {
		return "PrmntAddress [pincode=" + pincode + ", country=" + country + ", city=" + city + ", state=" + state
