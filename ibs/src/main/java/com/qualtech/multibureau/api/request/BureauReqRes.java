...
@Entity
@Table(name = "IB_BUREAU_REQ_RES")
public class BureauReqRes implements Cloneable{
	...
	@SequenceGenerator(name = "my_gen", sequenceName = "IB_BUREAU_MAIN_SQC", allocationSize = 1)
	@Column(name = "EID")
	public int getEid() {
		return eid;
	}
	...
	public String toString() {
		return "BureauReqRes [uniqueId=" + uniqueId + ", eid=" + eid + ", tag=" + tag + ", description=" + description
