...
@Entity
@Table(name="IB_K_ADDRESS_RES")
public class AddressData1 implements Serializable{


	private static final long serialVersionUID = -8251784410816419882L;
	
	@Id
    @GeneratedValue(generator="address1")
	@SequenceGenerator(name="address1",sequenceName="IB_K_ADDRESS1_SQC")
    @JsonIgnore
	private int kid;
	...
	public String toString() {
		return "AddressData1 [building=" + building + ", pin=" + pin + ", district=" + district + ", floor=" + floor
