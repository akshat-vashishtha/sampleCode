...
@Entity
@Table(name="IB_K_WEBDOMAIN_TECH_RES")
public class WebsiteDomainTech implements Serializable {
	...
	@Id
	@GeneratedValue(generator="TECH")
	@SequenceGenerator(name="TECH",sequenceName="IB_K_WD_TECH_SQC")
	@JsonIgnore
	private Long kid;
	...
	public String toString() {
		return "WebsiteDomainTech [city=" + city + ", fax=" + fax + ", name=" + name + ", country=" + country
