...
@Entity
@Table(name="IB_K_REQ_RES")
public class KarzaReqRes implements Serializable{
	/**
	 * 
	 */
	...
	public String toString() {
		return "KarzaReqRes [uniqueId=" + uniqueId + ", request=" + request + ", response=" + response + ", tag=" + tag
				...
				+ userid + ", password=" + password + ", token=" + token + ", status=" + status + ", updated_Time="
				+ updated_Time + ", pdfPath=" + pdfPath + ", intReq=" + intReq + ", intRes=" + intRes + ", price="
				+ price + "]";
	}
	 @Column(name="PRICE")
...
/*	@Id
	...
	@Id
	@GeneratedValue(generator="my_gen")
	@SequenceGenerator(name="my_gen",sequenceName="IB_K_MAIN_SQC",allocationSize=1)
	@Column(name="EID")
	public int getEid() {
		return eid;
	}
