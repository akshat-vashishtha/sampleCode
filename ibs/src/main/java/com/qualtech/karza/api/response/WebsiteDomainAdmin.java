...
@Entity
@Table(name="IB_K_WEBDOMAIN_ADMIN_RES")
public class WebsiteDomainAdmin implements Serializable {
	...
	@SequenceGenerator(name="ADMIN",sequenceName="IB_K_WD_ADMIN_SQC")
	@JsonIgnore
	private Long kid;
	...
	public String toString() {
		return "WebsiteDomainAdmin [city=" + city + ", fax=" + fax + ", name=" + name + ", country=" + country
