<html><head>  
  <title>Equifax Mico finance service</title>
  <style type="text/css">
table
{
padding-left:60px;
...
textarea {
  ...
  <h1>Equifax Micro finance Service</h1>
 </div>
...
<!-- </table> -->
<!--     </form> -->
  <form action="downloadrequestJsonMFI" method="post">
    
  <table>
    <tr height="40px">
    <td>
    <input type="submit" class="button_style1" value="Download Request json for Micro Finance" ">
    </td>
  </table>
  </form>
  
  <form name="equifaxOutPut" action="equifaxMfiHtml" method="post" >
  <table>
    <tbody>
    <%--
