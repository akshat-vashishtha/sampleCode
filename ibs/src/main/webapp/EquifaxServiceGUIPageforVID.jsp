<html><head>  
  <title>Equifax Verification Identification Service</title>
  <style type="text/css">
table
{
padding-left:60px;
...
textarea {
  ...
  <h1>Equifax Verification Identification Service</h1>
 </div>
...
<!-- </table> -->
<!--     </form> -->
  <form action="downloadrequestJsonVID" method="post">
    
  <table>
    <tr height="40px">
    <td>
    <input type="submit" class="button_style1" value="Download Request json for Verification ID Resport" ">
    </td>
  </table>
  </form>
  
  <form name="equifaxOutPut" action="equifaxUserFriendlyOutPutForVID" method="post" >
  <table>
    <tbody>
    <%--
