<html>
<head>
<title>Criff Service for Consumer</title>
<style type="text/css">
table {
	padding-left: 60px;
}
...
<script>
	...
	function onEnterRequestJsonforhtmlfile() {
		if (document.getElementById("requestJson").value == '') {
			...
			document.getElementById("requestJsonforHtmlDownload").value = document
					.getElementById("requestJson").value;
			document.downloadHtml.submit();
		}
	}
</script>
</head>
<body style="background-color: #EEEDE7">
	<div style="background-color: #D4EFDF; text-align: center;">
		<h1>Criff Service for Consumer</h1>
	</div>
	...
	<form action="downloadHtml" name="downloadHtml">
		<table style="padding-top: 30px;">
			<tr height="70px;">
				<td>
					<input type="hidden" name="requestJsonforHtmlDownload"
					id="requestJsonforHtmlDownload" value=""> 
					<input type="hidden" name="serviceType" value="CONSUMER">
					<input type="button" class="button_style1" value="Download as html"
					onclick="onEnterRequestJsonforhtmlfile()">
				</td>
			</tr>
		</table>
	</form>
	--%>
	<form action="downloadrequestJson" method="post">

		<table>
			<tr height="40px">
				<td><input type="submit" class="button_style1"
					value="Download Request json""></td>
		</table>
	</form>
	<form action="ShowCrifOutputForMFI.jsp" method="post">
		<table>
			<tr height="40px">
				<td><input type="submit" class="button_style1"
					value="Redirect to Crif Micro Finance Services""></td>
		</table>
	</form>
	
	
	<form name="crifoutpiut" action="getCrifOutPut" method="post">
		<table>
			<tbody>
				<tr height="40px">
