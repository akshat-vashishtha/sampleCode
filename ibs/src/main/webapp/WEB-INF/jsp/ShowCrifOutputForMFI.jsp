...
<body style="background-color: #EEEDE7">
	<div style="background-color: #D4EFDF; text-align: center;">
		<h1>Criff Micro Finance Service</h1>
	</div>
	...
	<form action="downloadHtml" name="downloadHtml">
		<table style="padding-top: 30px;">
			<tr height="70px;">
				<td><input type="hidden" name="requestJsonforHtmlDownload"
					id="requestJsonforHtmlDownload" value="">
					<input type="hidden" name="serviceType" value="MFI">
					 <input
					type="button" class="button_style1" value="Download as html"
	...
	--%>
	<form action="downloadRequestJsonForMFI" method="post">
	...
	<form name="crifoutpiut" action="criffResponseforMicroFinance" method="post">
		<table>
			<tbody>
				<tr height="40px">
