												...
												<td class="dataValue" width="55%">
													<table width="100%" cellspacing="0">
														<tbody>
															...
															<tr>
																<td class="dataValue" style="padding-left: 10px;">
																	<span class="fontWeight">Consumers with less than 6 months credit history* : </span> 0
																</td>
															</tr>
						...
						<tbody>
							...
							<tr>
								...
								<td width="171 px"
									...
									class="dataHeader">Date Of Birth</td>
					...
					<table border="0" align="left"
						...
						<tbody>
							<tr>
								<td>
									<%
										//JSONObject addresses = payloadjson.getJSONObject("addresses");
										try {
											String payload = request.getAttribute("payload") + "";
											JSONObject payloadjson = new JSONObject(payload);
											...
											for (int i = 0; i < addresses.length(); i++)
											{
												...
												String addressline2 = address.get("addressline2") + "";
												String addressline3 = address.get("addressline3") + "";
												String addressline4 = address.get("addressline4") + "";
												String addressline5 = address.get("addressline5") + "";
												String stateCode = address.get("stateCode") + "";
												String pinCode = address.get("pinCode") + "";
												if ("null".equals(addressline1)) {
													addressline1 = "";
												}
												try{addressline1 = (((((addressline1.trim()+" "+ addressline2).trim()+" "+addressline3).trim()+" "+addressline4).trim()+" "+addressline5).trim()+" "+stateCode).trim()+" "+pinCode;
												}catch(Exception ex){}
					...
					<table border="0" width="100%">
						<tbody>
							...
							<tr style="background: #e5e5e5">
								...
								<td width="114 px" class="dataValue"><span class="fontWeight">Income : </span><%=CibilUtil.commaSeprated(income)%>
								</td>
							...
							<tr>
								...
								<td width="114 px" class="dataValue"><span class="fontWeight">Net/Gross : </span><%=grosssIncomeindicator.isEmpty()?"Not Available":grosssIncomeindicator%>
								</td>
							...
							<tr style="background: #e5e5e5">
								...
								<td width="114 px" class="dataValue"><span class="fontWeight">Monthly/Annual : </span> <%=monthlyIncomeIndicator.isEmpty()?"Not Available":monthlyIncomeIndicator%>
								</td>
							...
							<tr height="20">
								...
								<tbody>
									<tr style="background: #e5e5e5;">
										...
										<td class="dataHeader" width="20%"></td><!-- Counts -->
									</tr>
									<tr style="background: #e5e5e5;">
									...
									<tr style="background: #e5e5e5;">
										<td class="dataValue" width="20%" style="padding-left: 10px;"><span class="fontWeight">Suit Filed/Wilful : </span><%try {%> <%=account.get("suitfiled_wilfulCount")%> <%} catch (Exception ec) {}%></td>
										<td class="dataValue" width="20%"><span class="fontWeight"></span></td>
										<td class="dataValue" width="20%"><span class="fontWeight"></span></td>
										<td class="dataValue" width="20%"><span class="fontWeight"></span></td>
										<td class="dataValue" width="20%"><span class="fontWeight"></span></td>
									...
									<tr style="background: #e5e5e5;">
										<td class="dataValue" width="20%" style="padding-left: 10px;"><span class="fontWeight">Written-off & settled : </span><%try {%> <%=account.get("writtenOffAndSettleCount")%> <%} catch (Exception ec) {}%></td>
										<td class="dataValue" width="20%"><span class="fontWeight"></span></td>
										<td class="dataValue" width="20%"><span class="fontWeight"></span></td>
										<td class="dataValue" width="20%"><span class="fontWeight"></span></td>
										<td class="dataValue" width="20%"><span class="fontWeight"></span></td>
			...
			<tr>
				<td>
					<table cellspacing="0" align="left" style="border-bottom:2px solid  #1675a5;" width="100%">
						<tbody>
							<tr height="20">
								<td class="mainHeader" style="font-size: 14px; padding-left:10px;">Summary For All  Enquiries</td>
							</tr>
						</tbody>
					</table>
					<table border="0" width="100%">
						<tbody>
							...
							<%try {%> <% if(enquiries.get("enquiryPurpose").equals("All Enquiries")){%>
								<td height="20" width="30%" style="text-align: left; padding-left: 10px;border-bottom: 1px solid #1675a5;border-top: 2px solid #1675a5;" class="dataValue">
									<%try {%> <%=enquiries.get("enquiryPurpose")%> <%} catch (Exception ec) {}%>
								</td>
								<td height="20" width="11%" style="text-align: center;border-bottom: 1px solid #1675a5;border-top: 2px solid #1675a5;" class="dataValue">
									<%try {%> <%=enquiries.get("total")%>
									<%} catch (Exception ec) {}%>
								</td>
								<td height="20" style="text-align: center;border-bottom: 1px solid #1675a5;border-top: 2px solid #1675a5;" width="11%"  class="dataValue">
								...
								<td height="20" width="15%" style="text-align:center;border-bottom:  1px solid #1675a5; border-top: 2px solid #1675a5;" class="dataValue">
						...
						<td colspan="3">
							<table width="100%" cellspacing="0">
								...
								<tr>
										...
										<td class="dataHeader" width="25%" style="padding-left: 10px;">Dates</td>
										<td class="dataHeader" width="25%" style="padding-left: 10px;">Amounts</td>
										<td class="dataHeader" width="25%" style="padding-left: 10px;">Status</td>
								...
								<td width="25%" style="vertical-align:top;">
									...
									<tbody>
										...
										<%try {									
											if(account.get("reportingMemberName")!=null &&!account.get("reportingMemberName").equals("NA")){%>
											<tr>
												<td class="dataValue"  width="100%" style="padding-left: 10px;vertical-align:middle;"><span class="fontWeight">Member Name : </span><%try {%> <%=account.get("reportingMemberName")%> <%} catch (Exception ec) {}%></td>
											</tr>
											<%}
										} catch (Exception ec) {}%>
										<%try {									
											if(account.get("accountNumber")!=null &&!account.get("accountNumber").equals("NA")){%>
											<tr>	
												<td class="dataValue"  width="100%" style="padding-left: 10px;vertical-align:middle;"><span class="fontWeight">Account Number : </span><%try {%> <%=account.get("accountNumber")%> <%} catch (Exception ec) {}%></td>
											</tr>
											<%}
										} catch (Exception ec) {}%>
										<%try {									
											if(account.get("accountType")!=null &&!account.get("accountType").equals("NA")){%>
											<tr>	
												<td class="dataValue"  width="100%" style="padding-left: 10px;vertical-align:middle;"><span class="fontWeight">Type : </span><%try {%> <%=account.get("accountType")%> <%} catch (Exception ec) {}%></td>
											</tr>
											<%}
										} catch (Exception ec) {}%>
										
										<%try {									
											if(account.get("ownershipIndicator")!=null &&!account.get("ownershipIndicator").equals("NA")){%>
											<tr>	
												<td class="dataValue" width="100%" style="padding-left: 10px;vertical-align:middle;"><span class="fontWeight">Ownership : </span><%try {%> <%=account.get("ownershipIndicator")%> <%} catch (Exception ec) {}%></td>
											</tr>
											<%}
										} catch (Exception ec) {}%>
										
										<%try {									
											if(account.get("rateOfInterest")!=null &&!account.get("rateOfInterest").equals("NA")){%>
											<tr>	
												<td class="dataValue" width="100%" style="padding-left: 10px;vertical-align:middle;"><span class="fontWeight">Interest Rate : </span><%try {%> <%=account.get("rateOfInterest")%> <%} catch (Exception ec) {}%></td>
											</tr>
											<%}
										} catch (Exception ec) {}%>
										
										<%try {									
											if(account.get("repaymentTenure")!=null &&!account.get("repaymentTenure").equals("NA")){%>
											<tr>	
												<td class="dataValue"  width="100%" style="padding-left: 10px;vertical-align:middle;"><span class="fontWeight">Repayment Tenure : </span><%try {%> <%=account.get("repaymentTenure")!=null &&!account.get("repaymentTenure").equals("NA")?CibilUtil.commaSeprated(account.get("repaymentTenure").toString()):account.get("repaymentTenure") %> <%} catch (Exception ec) {}%></td>
											</tr>
											<%}
										} catch (Exception ec) {}%>
										
										<%try {									
											if(account.get("paymentfrequency")!=null &&!account.get("paymentfrequency").equals("NA")){%>
											<tr>	
												<td class="dataValue"  width="100%" style="padding-left: 10px;vertical-align:middle;"><span class="fontWeight">Payment Frequency : </span><%try {%> <%=account.get("paymentfrequency")%> <%} catch (Exception ec) {}%></td>
											</tr>
											<%}
										} catch (Exception ec) {}%>
										<tr>	
								...
								<td width="25%" style="vertical-align:top;">
									...
									<tbody>
												...
												<%try {									
											if(account.get("dateOpened")!=null &&!account.get("dateOpened").equals("NA")){%>
												<tr>
													<td class="dataValue" style="vertical-align:middle;" width="100%"><span class="fontWeight">Opened : </span><%try {%> <%=account.get("dateOpened")%> <%} catch (Exception ec) {}%></td>
												</tr>
											<%}
										} catch (Exception ec) {}%>
										<%try {									
											if(account.get("dateOfLastPayment")!=null &&!account.get("dateOfLastPayment").equals("NA")){%>
											<tr>
												<td class="dataValue" style="vertical-align:middle;" width="100%"><span class="fontWeight">Last Payment : </span><%try {%> <%=account.get("dateOfLastPayment")%> <%} catch (Exception ec) {}%></td>
											</tr>
											<%}
										} catch (Exception ec) {}%>
										<%try {									
											if(account.get("dateClose")!=null &&!account.get("dateClose").equals("NA")){%>
											<tr>	
												<td class="dataValue" style="vertical-align:middle;" width="100%"><span class="fontWeight">Closed : </span><%try {%> <%=account.get("dateClose")%> <%} catch (Exception ec) {}%></td>
											</tr>
											<%}
										} catch (Exception ec) {}%>
										
										<%try {									
											if(account.get("dateReportedVerified")!=null &&!account.get("dateReportedVerified").equals("NA")){%>
											<tr>	
												<td class="dataValue" style="vertical-align:middle;" width="100%"><span class="fontWeight">Reported And Cerrtified : </span><%try {%> <%=account.get("dateReportedVerified")%> <%} catch (Exception ec) {}%></td>
											</tr>
											<%}
										} catch (Exception ec) {}%>
										
										<%try {									
											if(account.get("dateOfEntryForErrorcode")!=null &&!account.get("dateOfEntryForErrorcode").equals("NA")){%>
											<tr>	
												<td class="dataValue" style="vertical-align:middle;" width="100%"><span class="fontWeight">Entry Error Code : </span><%try {%> <%=account.get("dateOfEntryForErrorcode")%> <%} catch (Exception ec) {}%></td>
											</tr>
											<%}
										} catch (Exception ec) {}%>
										
										<%try {									
											if(account.get("dateOfEntryForCibilRemarkscode")!=null &&!account.get("dateOfEntryForCibilRemarkscode").equals("NA")){%>
											<tr>	
												<td class="dataValue" width="100%" style="vertical-align:middle;"><span class="fontWeight">Entry Cibil Remarks Code : </span><%try {%> <%=account.get("dateOfEntryForCibilRemarkscode")%><%} catch (Exception ec) {}%></td>
											</tr>
											<%}
										} catch (Exception ec) {}%>
										
										<%try {									
											if(account.get("dateOfERemarksCode")!=null &&!account.get("dateOfERemarksCode").equals("NA")){%>
											<tr>	
												<td class="dataValue" style="vertical-align:middle;" width="100%"><span class="fontWeight">Entry Error/Dispute Remarks Code : </span><%try {%> <%=account.get("dateOfERemarksCode")%> <%} catch (Exception ec) {}%></td>
											</tr>
											<%}
										} catch (Exception ec) {}%>
										
										<%try {									
											if(account.get("paymentHstrStartDate")!=null &&!account.get("paymentHstrStartDate").equals("NA")){%>
												<tr>	
												<td class="dataValue" style="vertical-align:middle;" width="100%"><span class="fontWeight">Payment History Start : </span><%try {%> <%=account.get("paymentHstrStartDate")%> <%} catch (Exception ec) {}%></td>
											</tr>
											<%}
										} catch (Exception ec) {}%>
											
											<%try {									
											if(account.get("paymentHistoryEndDate")!=null &&!account.get("paymentHistoryEndDate").equals("NA")){%>
											<tr>	
												<td class="dataValue" style="vertical-align:middle;" width="100%"><span class="fontWeight">Payment History End : </span><%try {%> <%=account.get("paymentHistoryEndDate")%> <%} catch (Exception ec) {}%></td>
											</tr>
											<%}
										} catch (Exception ec) {}%>
								...
								<td width="25%" style="vertical-align:top;">
									<table width="100%" cellspacing="0">
										<tbody>
											...
											<%try {									
											if(account.get("sanctionAmount")!=null &&!account.get("sanctionAmount").equals("NA")){%>
											<tr>
												<td class="dataValue" width="100%" style="vertical-align:middle;"><span class="fontWeight">Sanctioned : </span><%try {%> <%=account.get("sanctionAmount")!=null &&!account.get("sanctionAmount").equals("NA")?CibilUtil.commaSeprated(account.get("sanctionAmount").toString()):account.get("sanctionAmount") %> <%} catch (Exception ec) {}%></td>
											</tr>
											<%}
										} catch (Exception ec) {}%>
										<%try {									
											if(account.get("currntBalance")!=null &&!account.get("currntBalance").equals("NA")){%>
											<tr>	
												<td class="dataValue" width="100%" style="vertical-align:middle;"><span class="fontWeight">Current : </span><%try {%> <%=account.get("currntBalance")!=null &&!account.get("currntBalance").equals("NA")?CibilUtil.commaSeprated(account.get("currntBalance").toString()):account.get("currntBalance") %> <%} catch (Exception ec) {}%></td>
											</tr>
											<%}
										} catch (Exception ec) {}%>
										<%try {									
											if( account.get("amountOverdue")!=null && !account.get("amountOverdue").equals("NA") && !account.get("amountOverdue").equals("")){%>
											<tr>	
												<td class="dataValue" width="100%" style="vertical-align:middle;"><span class="fontWeight">Overdue : </span><%try {%> <%=account.get("amountOverdue")!=null &&!account.get("amountOverdue").equals("NA")?CibilUtil.commaSeprated(account.get("amountOverdue").toString()):account.get("amountOverdue") %> <%} catch (Exception ec) {}%></td>
											</tr>
											<%}
										} catch (Exception ec) {}%>
										
										<%try {									
											if( account.get("creditLimit")!=null && !account.get("creditLimit").equals("NA") && !account.get("creditLimit").equals("")){%>
												<tr>	
												<td class="dataValue" width="100%" style="vertical-align:middle;"><span class="fontWeight">Credit Limit : </span><%try {%> <%=account.get("creditLimit")!=null &&!account.get("creditLimit").equals("NA")?CibilUtil.commaSeprated(account.get("creditLimit").toString()):account.get("creditLimit") %> <%} catch (Exception ec) {}%></td>
											</tr>
											<%}
										} catch (Exception ec) {}%>
										
										<%try {									
											if(account.get("cashLimit")!=null && !account.get("cashLimit").equals("NA") && !account.get("cashLimit").equals("")){%>
											<tr>	
												<td class="dataValue" width="100%" style="vertical-align:middle;"><span class="fontWeight">Cash Limit : </span><%try {%> <%=account.get("cashLimit")%> <%} catch (Exception ec) {}%></td>
											</tr>
											<%}
										} catch (Exception ec) {}%>
										
										<%try {									
											if(account.get("emiAmount")!=null &&!account.get("emiAmount").equals("NA")){%>
											<tr>	
												<td class="dataValue" width="100%" style="vertical-align:middle;"><span class="fontWeight">EMI : </span><%try {%> <%=account.get("emiAmount")!=null &&!account.get("emiAmount").equals("NA")?CibilUtil.commaSeprated(account.get("emiAmount").toString()):account.get("emiAmount") %> <%} catch (Exception ec) {}%></td>
											</tr>
											<%}
										} catch (Exception ec) {}%>
										
										<%try {									
											if(account.get("writtenOffAmountTotal")!=null && !account.get("writtenOffAmountTotal").equals("NA")){%>
											<tr>	
												<td class="dataValue" width="100%" style="vertical-align:middle;"><span class="fontWeight">Written-Off Total : </span><%try {%> <%=account.get("writtenOffAmountTotal")!=null && !account.get("writtenOffAmountTotal").equals("NA")?CibilUtil.commaSeprated(account.get("writtenOffAmountTotal").toString()):account.get("writtenOffAmountTotal") %> <%} catch (Exception ec) {}%></td>
											</tr>
											<%}
										} catch (Exception ec) {}%>
										
										<%try {									
											if(account.get("writtenOffAmountPrincipal")!=null && !account.get("writtenOffAmountPrincipal").equals("NA")){%>
											<tr>	
												<td class="dataValue" style="vertical-align:middle;" width="100%"><span class="fontWeight">Written-Off Principal : </span><%try {%> <%=account.get("writtenOffAmountPrincipal")!=null && !account.get("writtenOffAmountPrincipal").equals("NA")?CibilUtil.commaSeprated(account.get("writtenOffAmountPrincipal").toString()):account.get("writtenOffAmountPrincipal") %> <%} catch (Exception ec) {}%></td>
											</tr>
											<%}
										} catch (Exception ec) {}%>
										
										<%try {									
											if(account.get("settlementAmount")!=null && !account.get("settlementAmount").equals("NA") && !account.get("settlementAmount").equals("")){%>
											<tr>	
												<td class="dataValue" width="100%" style="vertical-align:middle;"><span class="fontWeight">Settlement : </span><%try {%> <%=account.get("settlementAmount")!=null && !account.get("settlementAmount").equals("NA")?CibilUtil.commaSeprated(account.get("settlementAmount").toString()):account.get("settlementAmount") %> <%} catch (Exception ec) {}%></td>
											</tr>
											<%}
										} catch (Exception ec) {}%>
										
										<%try {									
											if(account.get("actualPaymentAmount")!=null && !account.get("actualPaymentAmount").equals("NA") && !account.get("actualPaymentAmount").equals("")){%>
											<tr>	
												<td class="dataValue" width="100%" style="vertical-align:middle;"><span class="fontWeight">Actual Payment : </span><%try {%> <%=account.get("actualPaymentAmount")!=null && !account.get("actualPaymentAmount").equals("NA")?CibilUtil.commaSeprated(account.get("actualPaymentAmount").toString()):account.get("actualPaymentAmount") %> <%} catch (Exception ec) {}%></td>
											</tr>
											<%}
										} catch (Exception ec) {}%>
										<tr>	
								...
								<td width="25%" style="vertical-align:top;">
										...
										<tbody>
											...
											<%try {									
											if(account.get("suitfilledDefault")!=null && !account.get("suitfilledDefault").equals("NA") && !account.get("suitfilledDefault").equals("")){%>
											<tr>
												<td class="dataValue" width="100%" style="vertical-align:middle;"><span class="fontWeight">Suit Filed/Wilful : </span><%try {%> <%=account.get("suitfilledDefault")%> <%} catch (Exception ec) {}%></td>
											</tr>
											<%}
										} catch (Exception ec) {}%>
										<%try {									
											if(account.get("writtenOffStatus")!=null &&!account.get("writtenOffStatus").equals("NA") && !account.get("writtenOffStatus").equals("")){%>
											<tr>	
												<td class="dataValue" width="100%" style="vertical-align:middle;"><span class="fontWeight">Written-Off And Settled : </span><%try {%> <%=account.get("writtenOffStatus")%> <%} catch (Exception ec) {}%></td>
											</tr>
											<%}
										} catch (Exception ec) {}%>
										<%try {									
											if(account.get("valueOfColleteral")!=null &&!account.get("valueOfColleteral").equals("NA") && !account.get("valueOfColleteral").equals("")){%>
											<tr>	
												<td class="dataValue" width="100%" style="vertical-align:middle;"><span class="fontWeight">Collateral Value : </span><%try {%> <%=account.get("valueOfColleteral")%> <%} catch (Exception ec) {}%></td>
											</tr>
											<%}
										} catch (Exception ec) {}%>
										
										<%try {									
											if(account.get("typeOfColleteral")!=null &&!account.get("typeOfColleteral").equals("NA") && !account.get("typeOfColleteral").equals("")){%>
											<tr>	
												<td class="dataValue" width="100%" style="vertical-align:middle;"><span class="fontWeight">CollateralL Type : </span><%try {%> <%=account.get("typeOfColleteral")%> <%} catch (Exception ec) {}%></td>
											</tr>
											<%}
										} catch (Exception ec) {}%>
										
										<%try {									
											if(account.get("errorCode")!=null &&!account.get("errorCode").equals("NA") && !account.get("errorCode").equals("")){%>
											<tr>	
												<td class="dataValue" width="100%" style="vertical-align:middle;"><span class="fontWeight">Error Code : </span><%try {%> <%=account.get("errorCode")%> <%} catch (Exception ec) {}%></td>
											</tr>
											<%}
										} catch (Exception ec) {}%>
										
										<%try {									
											if(account.get("cibilRemarksCode")!=null &&!account.get("cibilRemarksCode").equals("NA") && !account.get("cibilRemarksCode").equals("")){%>
											<tr>	
												<td class="dataValue" width="100%" style="vertical-align:middle;"><span class="fontWeight">Cibil Remarks Code : </span><%try {%> <%=account.get("cibilRemarksCode")%> <%} catch (Exception ec) {}%></td>
											</tr>
											<%}
										} catch (Exception ec) {}%>
										
										<%try {									
											if(account.get("errordisputecode1")!=null &&!account.get("errordisputecode1").equals("NA") && !account.get("errordisputecode1").equals("")){%>
											<tr>	
												<td class="dataValue" width="100%" style="vertical-align:middle;"><span class="fontWeight">Dispute Remarks Code1 : </span><%try {%> <%=account.get("errordisputecode1")%> <%} catch (Exception ec) {}%></td>
											</tr>
											<%}
										} catch (Exception ec) {}%>
										
										<%try {									
											if(account.get("errordisputcode2")!=null &&!account.get("errordisputcode2").equals("NA") && !account.get("errordisputcode2").equals("")){%>
											<tr>	
												<td class="dataValue" width="100%" style="vertical-align:middle;"><span class="fontWeight">Dispute Remarks Code2 : </span><%try {%> <%=account.get("errordisputcode2")%> <%} catch (Exception ec) {}%></td>
											</tr>
											<%}
										} catch (Exception ec) {}%>
...
<td height="5"></td>
			...
			<%
				try {
						String payloadN = request.getAttribute("payload") + "";
						JSONObject payloadJsonN = new JSONObject(payloadN);
						JSONArray additionalMatchDetails = payloadJsonN.getJSONArray("additionalMatchDetails");
						if(additionalMatchDetails!=null && additionalMatchDetails.length()>0)
						{
						for (int z = 0; z < additionalMatchDetails.length(); z++)
						{
							JSONObject additionalData = additionalMatchDetails.getJSONObject(z);
			%>
			
			
			<%
			String payload1 = request.getAttribute("payload") + "";
			JSONObject payloadJson1 = new JSONObject(payload1);
			%>
			...
			<tr>
				<td>
					<font  color="red">
					ADDITIONAL MATCHES -- YOUR ENQUIRY ON <%=payloadJson1.get("name1")+" "+payloadJson1.get("name2")+" "+payloadJson1.get("name3")+" "+payloadJson1.get("name4")+" "+payloadJson1.get("name5")%> RETURNED MULTIPLE FILES. SEE INFORMATION<br/>
					RELATED TO ADDITIONAL SUBJECT <%=additionalData.get("name1")+" "+additionalData.get("name2")+" "+additionalData.get("name3")+" "+additionalData.get("name4")+" "+additionalData.get("name5")%> BELOW.
					</font>
				</td>
			</tr>
			<tr><td height="5"></td></tr>
				...
				<td>
					...
					<table border="0" width="100%" align="center">
						<tbody>
							...
							<%
								try {
									JSONObject payloadJson = additionalData;
									String dateofBirth = payloadJson.get("dateofBirth") + "";
									String gendercode = payloadJson.get("gender") + "";
									String gender = "";
									if ("1".equals(gendercode)) {
										gender = "Female";
									} else if ("2".equals(gendercode)) {
