<html><head>  
  <title>Equifax EVDR Service</title>
  <style type="text/css">
table
{
padding-left:60px;
...
textarea {
  ...
  <h1>Equifax Enhance verification Demographic Service </h1>
 </div>
...
<!-- </table> -->
<!--     </form> -->
  <form action="downloadrequestJsonEVDR" method="post">
    
  <table>
    <tr height="40px">
    <td>
    <input type="submit" class="button_style1" value="Download Request json for Enhance Verification ID Resport" ">
    </td>
  </table>
  </form>
  
  <form name="equifaxOutPut" action="equifaxuserfriendlyoutputforEVDR" method="post" >
  <table>
    <tbody>
    <%--
